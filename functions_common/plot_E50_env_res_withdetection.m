function plot_E50_env(ku, ex, delta, x_ku_in_o, y_ku_in_o)
...
% figure(1)
hold on
plot_env_(ku, x_ku_in_o, y_ku_in_o)
...
function plot_env_(lenKu, x_ku_in_o, y_ku_in_o)
D = 2.25; % 库位深度
plot([-7,7] + x_ku_in_o, [5,5] + y_ku_in_o ,'k','linewidth',2);
xlim([-1 10])
ylim([-6 6])
grid on;hold on;
plot([-lenKu,-lenKu] + x_ku_in_o, [-D,0] + y_ku_in_o,'k','linewidth',2);
plot([-7,-lenKu] + x_ku_in_o,[0,0]+ y_ku_in_o,'k','linewidth',2);
plot([-7,7] + x_ku_in_o,[-D,-D]+ y_ku_in_o,'k','linewidth',2);
plot([0,0] + x_ku_in_o,[-D,0]+ y_ku_in_o,'k','linewidth',2);
plot([0,7] + x_ku_in_o,[0,0]+ y_ku_in_o,'k','linewidth',2);
end