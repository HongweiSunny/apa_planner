...
if(apa_planner_CONFIG_INCLUDED)
  return()
endif()
set(apa_planner_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(apa_planner_SOURCE_PREFIX /home/shw/catkin_ws_sakichen/src/apa_planner)
  set(apa_planner_DEVEL_PREFIX /home/shw/catkin_ws_sakichen/src/apa_planner/build/devel)
  set(apa_planner_INSTALL_PREFIX "")
  set(apa_planner_PREFIX ${apa_planner_DEVEL_PREFIX})
else()
  set(apa_planner_SOURCE_PREFIX "")
  set(apa_planner_DEVEL_PREFIX "")
  set(apa_planner_INSTALL_PREFIX /usr/local)
  set(apa_planner_PREFIX ${apa_planner_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'apa_planner' is deprecated")
...
set(apa_planner_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/shw/catkin_ws_sakichen/src/apa_planner/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(apa_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/shw/catkin_ws_sakichen/src/apa_planner/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${apa_planner_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'apa_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'apa_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shw/catkin_ws_sakichen/src/apa_planner/${idir}'.  ${_report}")
    endif()
    _list_append_unique(apa_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND apa_planner_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND apa_planner_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT apa_planner_NUM_DUMMY_TARGETS)
      set(apa_planner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::apa_planner::wrapped-linker-option${apa_planner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR apa_planner_NUM_DUMMY_TARGETS "${apa_planner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::apa_planner::wrapped-linker-option${apa_planner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND apa_planner_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shw/catkin_ws_sakichen/src/apa_planner/build/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(apa_planner_LIBRARY_DIRS ${lib_path})
      list(APPEND apa_planner_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'apa_planner'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND apa_planner_LIBRARIES ${lib})
    endif()
  endif()
...
set(apa_planner_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${apa_planner_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 apa_planner_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${apa_planner_dep}_FOUND)
      find_package(${apa_planner_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${apa_planner_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(apa_planner_INCLUDE_DIRS ${${apa_planner_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(apa_planner_LIBRARIES ${apa_planner_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${apa_planner_dep}_LIBRARIES})
  _list_append_deduplicate(apa_planner_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(apa_planner_LIBRARIES ${apa_planner_LIBRARIES})

  _list_append_unique(apa_planner_LIBRARY_DIRS ${${apa_planner_dep}_LIBRARY_DIRS})
  list(APPEND apa_planner_EXPORTED_TARGETS ${${apa_planner_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${apa_planner_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
